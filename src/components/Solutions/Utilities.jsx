    ...
    return (
        <div>
            ...
            <div className='w-full py-20 px-8 md:px-16 bg-gray-200 transition-colors duration-300 dark:bg-[#272727] dark:text-white justify-center items-center text-center'>
                <div>
                    <h1 className = "text-[#005777] dark:text-[#0E8AFE] font-bold md:text-4xl sm:text-3xl text-2xl py-6">For Utilities</h1>
                    <p className='w-[60%] mx-auto text-gray-600 dark:text-gray-400'>
                        Green Energy Operation Platform Enabling Utilities to Streamline Renewable Procurements,
                         Manage EAC Inventories, Operationalize Green Tariffs, and Offer Carbon Services for their Customers
                    </p>
                </div>
                    ...
                    <ul className="space-y-6 font-sans font-semibold text-lg w-[60%] text-left">
                        <li className="transition-colors duration-200 flex gap-x-4 items-start group">
                            ...
                            <span className="mt-[10px] leading-tight">
                                Develop green tariff rate designs and regulatory filings by providing the required analyses.
                            </span>
                        </li>
                        ...
                        <li className="transition-colors duration-200 flex gap-x-4 items-start group">
                            ...
                            <span className="mt-[10px] leading-tight">
                                Streamline renewable procurements including management, settlement, and billing of PPA contracts.
                            </span>
                        </li>
                        ...
                        <li className="transition-colors duration-200 flex gap-x-4 items-start group">
                            ...
                            <span className="mt-[10px] leading-tight">
                                Centralize the management of aggregate and 24x7 hourly EAC inventories of various vintages.
                            </span>
                        </li>
                        ...
                        <li className="transition-colors duration-200 flex gap-x-4 items-start group">
                            ...
                            <span className="mt-[10px] leading-tight">
                                Allocate hourly or aggregate RECs based on green tariff product definitions and requirements.
                            </span>
                        </li>
                        ...
                        <li className="transition-colors duration-200 flex gap-x-4 items-start group">
                            ...
                            <span className="mt-[10px] leading-tight">
                                Generate PDF attestation letters and supporting data for audit purposes.
                            </span>
                        </li>
                        ...
                        <li className="transition-colors duration-200 flex gap-x-4 items-start group">
                            ...
                            <span className="mt-[10px] leading-tight">
                                Deliver all auditable and reconcilable data for green tariffs through energy portals to customers.
                            </span>
                        </li>
                    </ul>
                </div>
