...
import MeterManagement from '../../assets/productImages/meter-management.jpg'
import HydroPower from '../../assets/productImages/hydropower.jpg'

const MDMS = () => {
    return (
        <div>
            <title>Meter Data Management System</title>
            {/*Page Header*/}
                ...
                <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-8 my-16 px-4">
                    <div className="flex flex-col justify-center items-center w-full md:w-[80%] mx-auto text-center">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            The CFEX MDMS product centralizes the management of load and generation meter data and standardizes
                             data exchange with counterparties. The MDMS supports data validation, exception handling, and versioning.
                        </p>
                    </div>
                    <img className="rounded-xl w-full max-w-[1200px] mx-auto my-4" src={MeterManagement} alt="Meter Management" />
                </div>
            </div>
        </div>
    )
