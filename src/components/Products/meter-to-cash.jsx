...
import Billing from '../../assets/productImages/billing.png'
import HydroPower from '../../assets/productImages/hydropower.jpg'

const MeterToCash = () => {
    return (
        <div>
            <title>Billing and Settlement System</title>
            {/*Page Header*/}
                ...
                <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-8 my-16 px-4">
                    <div className="flex flex-col justify-center items-center w-full md:w-[80%] mx-auto text-center">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            The CFEX Meter-to-Cash product accurately settles energy contracts for counterparties 
                            on both sides of the transaction. For renewable energy sellers, it automates the monthly billing
                            and invoicing processes. For renewable energy buyers, it automates the invoice reconciliation process.
                        </p>
                    </div>
                    <img className="rounded-xl w-full max-w-[1200px] mx-auto my-4" src={Billing} alt="Billing" />
                </div>
            </div>
        </div>
    )
